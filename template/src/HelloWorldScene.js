var helloWorldLayer = cc.Layer.extend({
    ctor:function(){
        this._super();
        cc.audioEngine.playMusic(s_Backgroundmusic, true); 
        cc.spriteFrameCache.addSpriteFrames(s_Background_plist);
        cc.spriteFrameCache.addSpriteFrames(s_Button_plist); 
        //cc.spriteFrameCache.addSpriteFrames(s_Jinscore_plist);

        var winSize = cc.director.getWinSize(); 

        var pCloseItem = new cc.MenuItemImage(s_CloseNormal,s_CloseSelected, 
            s_CloseSelected, this.menuCloseCallback,this);
    ...
    toGameLayer:function() {
        ...
        cc.audioEngine.playMusic(s_ModeSelect02,false);
